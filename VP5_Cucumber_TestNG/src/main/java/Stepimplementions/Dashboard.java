...
public class Dashboard extends TestBase {
	...
	String actul_Announcements_text = driver.findElement(By.xpath("//*[contains(text(), 'Announcements (')]")).getText();
	...
	String actul_banking_text = driver.findElement(By.xpath("//a[contains(text(), 'View Banking Details')]")).getText();
