...
public class Separation_steps extends TestBase{
	Goto go=new Goto();
	...
	public void fill_separtionform_save() 
	{
		try {
		go.admintab();
		...
		// using foreach loop we can click on all check boxes which are present in page 
...
//		}
	...
	public void search_edit_submit_form()
	{
		try {
